...
\newcommand{\officeHours}{Wednesdays 1-3 pm}
\newcommand{\officeHoursLocation}{CDRLC 4452}
...
\begin{longtable}{@{}
  ...
  >{\raggedright\arraybackslash}p{\dimexpr 0.5\linewidth-2\tabcolsep\relax}
  >{\raggedright\arraybackslash}p{\dimexpr 0.1\linewidth-2\tabcolsep\relax}
@{}}
\toprule
...
01/19 & Processes and System Calls & hw1: linking and shared libraries & CSAPP Ch 8.1-8.2 \\
01/26 & File I/O &  hw2: syscalls and signals \\
02/02 & Network I/O & hw3: runCommand and runInteractive \\
02/09 & Adv. I/O & hw4: socket server with epoll \\
02/16 & Memory Layout - Process and Data Structure &  \\
02/23 & Memory Management - Malloc and Mmap & hw5: learning about memory layout with gdb \\
03/02 & Adv. Memory Management & hw6: IPC over shared memory \\
03/09 & Midterm and Review &  \\
03/16 & Programming with Threads &  \\
\hline
03/23 & \textit{SPRING BREAK} \\
\hline
03/30 & Race Conditions, Synchronization and Deadlock & hw7: multi-threaded socket server \\
04/06 & Adv. Concurrency & hw8: concurrency bug hunt \\
04/13 & PTrace - the API for debugging &  \\
